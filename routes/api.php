 ...
 * PARENT APIs
 **/
Route::get('/fee-card', 'SchoolPrinting\FeeCardPrintController@TPrint');
Route::get('student-exam-result-pdf', [ApiController::class, 'getExamResultPdf']);
    ...
    Route::group(['middleware' => ['auth:api',]], function () {
       Route::get('announcements', [ParentApiController::class, 'getAnnouncements']);
        Route::group(['middleware' => ['auth:api', 'checkChild']], function () {
            ...
            Route::get('/receipt', 'SchoolPrinting\FeeCardPrintController@feesPaidReceiptPDF'); //Fees Receipt
            });
        });
    });
});
...
Route::get('/device-users',[App\Http\Controllers\Api\EmployeeAttendanceController::class, 'getEmployees']);
