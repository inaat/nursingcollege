...
Route::get('/single-voucher/{transaction_id}', 'VoucherController@singlePrint');


Route::get('/pay-slip/{transaction_id}', 'Hrm\HrmPayrollController@paySlip');

Route::get('/receipt-print/{payment_id}', 'SchoolPrinting\FeeCardPrintController@receiptPrint');
