...
Route::resource('assessment', 'TeacherLayout\AssessmentController');
Route::post('post-assessment', 'TeacherLayout\AssessmentController@postAssessment');
...
Route::resource('sms-email-templates', 'NotificationTemplateController');
