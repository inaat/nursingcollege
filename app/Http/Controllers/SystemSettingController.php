...
class SystemSettingController extends Controller
{
    ...
    public function index()
    {
        ...
        $provinces = \App\Models\Province::forDropdown($system_settings_id, false,!empty($common_settings['country_id'])
        ? $common_settings['country_id']
        : null );
        $districts = District::forDropdown($system_settings_id, false,!empty($common_settings['province_id'])
        ? $common_settings['province_id']
        : null);
        $cities = City::forDropdown($system_settings_id, false,!empty($common_settings['district_id'])
        ? $common_settings['district_id']
        : null);
        $regions = \App\Models\Region::forDropdown($system_settings_id, false,!empty($common_settings['city_id'])
        ? $common_settings['city_id']
        : null);
        return view('admin.global_configuration.global_configuration')->with(compact('countries','provinces','districts','cities','regions','theme_colors','mail_drivers','email_settings','common_settings','sms_settings','timezone_list', 'date_formats', 'month_list', 'currencies', 'general_settings'));
    }
