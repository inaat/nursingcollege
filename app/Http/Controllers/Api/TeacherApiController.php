...
class TeacherApiController extends Controller
{
        ...
        try {
            ...
            foreach ($request->attendance as $attendance) {
                ...
                if (!empty($check)) {
                    ...
                    if ($type == 'present') {
                        // $this->notificationUtil->autoSendNotification('student_attendance_check_in',null, $student, $attendance);
                    } elseif ($type == 'absent') {
    ...
    public function getExamList(Request $request)
    {
        ...
        $exam_data_db = ExamCreate::with(['session', 'term'])->where('session_id',getActiveSession());
