            ...
            if (!empty($request->subject_id)) {
                ...
                if (!empty($request->set_data)) {
                    if ($request->set_data == 'class_section') {
                        ...
                        $subject_teacher_id = SubjectTeacher::select('id')->where(['class_section_id' => $request->class_section_id,'teacher_id' => $teacher_id ,'subject_id' => $request->subject_id])->get()->pluck('id');
                        $subject_name = SubjectTeacher::where(['teacher_id' => $teacher_id,'class_section_id' => $request->class_section_id,'subject_id' => $request->subject_id])->with('class_subject')->get();
             ...
             if (empty($request->subject_id) && !empty($request->class_section_id) && !empty($request->class_id)) {
