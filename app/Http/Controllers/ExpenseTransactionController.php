...
class ExpenseTransactionController extends Controller
{
    ...
    */
            ...
            ->addColumn(
                ...
                function ($row) {
                    ...
                    if (auth()->user()->can('expense.expense_payment')) {
                        ...
                        $html .= '<hr><li><a href="#" data-href="' . action('ExpenseTransactionController@expenseReceiptPrint', [$row->id]) . '" class="dropdown-item print-invoice"><i class="fas fa-print"></i> ' . __("english.print") . '</a></li>';
    ...
    public function expenseReceiptPrint($id){
        try{
        $data = [
            'is_enabled' => false,
            'print_type' => 'browser',
        ...
        $transaction = ExpenseTransaction::with(['payment_lines','vehicle','employee','create_person','expenseCategory'])->findOrFail($id);
        $total_paid=$this->expenseTransactionUtil->getTotalPaid($id);
        ...
        $data['html_content'] = view('expense.print', compact('transaction','total_paid'))->render();
