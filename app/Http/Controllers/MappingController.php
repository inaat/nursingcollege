       ...
       // dd($students);
        foreach($students as $student){
            ...
            if(Empty($attendance)){
                ...
                $response=$this->notificationUtil->autoSendNotification('student_attendance_absent_sms', null,$student, $std_attendance);
                // if(empty($response)){
                    ...
                    if ($device_date==\Carbon::now()->format('Y')) {
                        ...
                        if (!empty($student)) {
                            ...
                            if (empty($attendance)) {
                                ...
                                $response=$this->notificationUtil->autoSendNotification('student_attendance_check_in', null,$student, $std_attendance);
                                // if (empty($response)) {
                                ...
                                if ($can_clockout) {
                                    if (empty($attendance->clock_out_time)) {
                                        ...
                                        $attendance->save();
                                        $response=$this->notificationUtil->autoSendNotification('student_attendance_check_out', null,$student, $attendance);
                                        // if (empty($response)) {
