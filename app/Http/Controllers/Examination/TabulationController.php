...
class TabulationController extends Controller
{
    ...
    ->where('exam_create_id', $input['exam_create_id'])->orderBy('student_id', 'ASC')->get();
    ...
    public function tabulationSheetPrint(Request $request)
    {
        ...
        if (request()->ajax()) {
            ...
            'msg' => trans("messages.something_went_wrong")
                ...
                $receipt = $this->bulkReceiptContent($details,$check_mat);
    ...
    private function bulkReceiptContent($details,$check_mat)
    {
        ...
        $output['html_content'] = view('Examination.tabulation_sheet.tabulation-sheet-print', compact('details','check_mat'))->render();
