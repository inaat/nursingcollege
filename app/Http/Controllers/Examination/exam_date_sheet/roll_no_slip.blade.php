...
<body style="color:#000;background-color:#ffff;">
    ...
    <div style="padding:10px; margin-top:20px;page-break-after: always;">
...
<div class="info">
 ...
 <div id="main">
            ...
            <table class="timecard" @if($std['dateSheet']->count()<7) style="zoom:75%;" @else style="zoom:70%;" @endif>
                <thead>
                ...
                <tfoot>
                    <tr>
                        <td colspan="{{ $std['dateSheet']->count() }}">
                            <p style="float:right; margin-top:10px;">@lang('english.controller_of_examination')<br>____________________________ </p>
                        </td>
                    <tr>
                </tfoot>
