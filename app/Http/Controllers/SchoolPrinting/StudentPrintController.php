...
class StudentPrintController extends Controller
{
    ...
    */
    ...
    {
        ini_set('pcre.backtrack_limit', '2000000'); // Increase limit to 2 million
    ...
    $section_list[]=[
        ...
        if ($pdf) {
         $this->reportPDF('samplereport.css', $student_list, 'MPDF.student-particular', 'view', 'a4');
            ...
            $snappy  = \WPDF::loadView('school-printing.student-print.student_particular', compact('student_list'));
