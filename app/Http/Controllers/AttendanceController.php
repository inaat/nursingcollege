...
//             $attendance = Attendance::where('student_id', $student->id)->whereDate('clock_in_time', '2023-05-13')->get();
                ...
                if (empty($attendance)) {
                    if (!empty($attend['status'])) {
                        ...
                        if($attend['status']=='present'){
                         ...
                         $this->notificationUtil->autoSendNotification('student_attendance_absent_sms', null,$student, $std_attendance);

                        }
                        elseif($attend['status']=='late'){
                            $this->notificationUtil->autoSendNotification('student_attendance_late_sms', null,$student, $std_attendance);

                        }
                        elseif($attend['status']=='half_day'){
                            $this->notificationUtil->autoSendNotification('student_attendance_half_day_sms', null,$student, $std_attendance);

                        }
                        elseif($attend['status']=='leave'){
                            $this->notificationUtil->autoSendNotification('student_attendance_leave_sms', null,$student, $std_attendance);
                    ...
                    if (!empty($attend['status'])) {
                        ...
                        $attendance->save();
                         ...
                         $this->notificationUtil->autoSendNotification('student_attendance_absent_sms', null,$student, $attendance);
