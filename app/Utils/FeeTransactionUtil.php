...
class FeeTransactionUtil extends Util
{
    ...
    */
     ...
     *
     */
    public function __paymentQuery($student_id, $session_id, $start=null, $end = null,$orderBuy=false)
    {
        ...
        if ($orderBuy) {
            return $query->orderBy('paid_on', 'desc')->get(); // Latest date first
        }
        return $query->get();
    }
    /**
