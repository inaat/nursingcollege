...
class AccountTransaction extends Model
{
    ...
    public function feeTransactionPayment()
    {
        return $this->belongsTo(FeeTransactionPayment::class, 'transaction_payment_id');
    }

    public function hrmTransactionPayment()
    {
        return $this->belongsTo(HrmTransactionPayment::class, 'hrm_transaction_payment_id');
    }
