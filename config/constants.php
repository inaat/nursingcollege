...
return [
    ...
    */
    'head_bg_color'=>'#1E5493',
     
    'langs' => [
        'en' => ['full_name' => 'English', 'short_name' => 'English'],
        'ur' => ['full_name' => 'Urdu', 'short_name' => 'Urdu'],
    ...
    'langs_rtl' => ['ar','ur'],
    'non_utf8_languages' => ['ar','ur','hi', 'ps'],
    ...
    'mapping_attendance_count_interval' => 3600, //Interval to check for new notifications in seconds;Default is 60sec
    ...
    'whatsapp_base_url' => 'http://127.0.0.1:8000',
    ...
    'sms_send_through_app'=>false, //
    'sms_send_through_whatsapp'=>true,
    'mpdf'=>true ,//
