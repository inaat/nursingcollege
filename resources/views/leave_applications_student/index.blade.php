...
@section('title', __('english.leave_applications_for_student'))
 @section('wrapper')
 <div class="page-wrapper">
     <div class="page-content">
         ...
         <div class="card">
             <div class="card-body">
                 <h5 class="card-title text-primary">@lang('english.all') @lang('english.your') @lang('english.leave_applications_for_student')</h5>
               <div class="d-lg-flex align-items-center mb-4 gap-3">
               @can('leave_applications_for_student.create')
                    <div class="ms-auto"><button type="button"
                                class="btn btn-primary radius-30 mt-2 mt-lg-0 add_new_leave_application"
                                data-href="{{ action('LeaveApplicationStudentController@create') }}"
                                data-container=".leave_applications_for_student_modal">
                 ...
                 <div class="table-responsive">
                     <table class="table mb-0" width="100%" id="leave_applications_for_student_table">
 ...
 <div class="modal fade leave_applications_for_student_modal contains_select2" tabindex="-1" role="dialog" aria-labelledby="gridSystemModalLabel">
 </div>
 @include('leave_applications_student.update_leave_status_modal')

 @endsection

 @section('javascript')
  <script src="{{ asset('js/leave_application_student.js?v=' . $asset_v) }}"></script>
