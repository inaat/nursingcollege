 ...
 <div class="page-wrapper">
             ...
             <div class="col">
                 <div class="card radius-10">
                     <div class="card-body">
                         <div class="d-flex align-items-center">
                             <div>
                                 <p class="mb-0 text-secondary "><a href="{{ action('AttendanceController@index').'?type=leave' }}">Total Leave Students</a></p>
                                 <h4 class="font-weight-bold info-box-number total_student_leave loader"><i class="widgets-icons  bg-light-success text-success fas fa-sync fa-spin fa-fw margin-bottom"></i></h4>
                             </div>
                             <div class="widgets-icons bg-light-success text-success ms-auto"><i class="bx bx-calendar"></i>
                             </div>
                         </div>
             ...
             <div class="col">
                 <div class="card radius-10">
                     <div class="card-body">
                         <div class="d-flex align-items-center">
                             <div>
                                 <p class="mb-0 text-secondary "><a href="{{ action('Hrm\HrmAttendanceController@index').'?type=late' }}">Total Employee Late</a></p>
                                 <h4 class="font-weight-bold info-box-number total_employee_late loader"><i class="widgets-icons  bg-light-danger text-danger fas fa-sync fa-spin fa-fw margin-bottom"></i></h4>
                             </div>
                             <div class="widgets-icons bg-light-danger text-danger ms-auto"><i class="bx bx-calendar"></i>
                             </div>
                         </div>
                     </div>
                 </div>
     ...
     <script>
         $(document).on('click', '#print_invoice2023', function() {
             $('.print_area2023').printThis();
         });
         $(document).on('click', '#print_invoice2024', function() {
             $('.print_area2024').printThis();
         });
