@extends('layouts.app')
@section('title', __('english.payment_account_report'))

@section('content')

<!-- Content Header (Page header) -->
<section class="content-header">
    <h1>{{ __('english.payment_account_report')}}</h1>
</section>
                ...
                <div class="box-body">
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            {!! Form::text('date_range', null, ['placeholder' => __('english.select_a_date_range'), 'class' => 'form-control', 'id' => 'date_filter', 'readonly']) !!}
                        </div>
                    </div>
                </div>
              </div>
                    ...
                    <table class="table table-bordered table-striped" id="payment_account_report">
                        <thead>
                            <tr>
                                ...
                                <th>@lang('english.invoice_ref_no')</th>
                                <th>@lang('english.payment_type')</th>
