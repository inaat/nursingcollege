...
@section('title', __('english.fee_allocation'))
 ...
 <div class="page-wrapper">
     <div class="page-content">
         ...
         {!! Form::open(['url' => action('OtherFeeAllocationController@feesAssignSearch'), 'method' => 'post', 'class'=>'needs-validation was-validated','novalidate'.'id' =>'search_student_fee' ,'files' => true]) !!}
             ...
             <div class="card-body">
                 ...
                 <div class="row m-0">
                     ...
                     <div class="col-md-3 p-2">
                                ...
                                {!! Form::select('type',['transport_fee'=>'Transport Fee','other_fee'=>'Other Fee'],'transport_fee', ['class' => 'form-select select2 ','required', 'style' => 'width:100%', 'required' ]) !!}
                    </div>
