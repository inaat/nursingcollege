     ...
     <div class="page-wrapper">
         <div class="page-content">
             ...
             <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
                 <div class="breadcrumb-title pe-3">@lang('english.other')  @lang('english.fees_allocation')</div>
                 <div class="ps-3">
                     <nav aria-label="breadcrumb">
                         <ol class="breadcrumb mb-0 p-0">
                             <li class="breadcrumb-item"><a href="{{ url('/home') }} "><i class="bx bx-home-alt"></i></a>
                             </li>
                             <li class="breadcrumb-item active" aria-current="page">@lang('english.other') @lang('english.fees_allocation')</li>
                         </ol>
                     </nav>
                 </div>
             </div>
             <!--end breadcrumb-->
             {!! Form::open(['url' => action('OtherFeeAllocationController@feesAssignSearch'), 'method' => 'post', 'class' => '', 'novalidate' . 'id' => 'search_student_fee', 'files' => true]) !!}
             ...
             <div class="card">
                 ...
                 <div class="card-body">
                     ...
                     <div class="col-md-3 p-2">
                                ...
                                {!! Form::select('type',['transport_fee'=>'Transport Fee','other_fee'=>'Other Fee'],$type, ['class' => 'form-select select2 ','required', 'style' => 'width:100%', 'required' ]) !!}
                    </div>
             ...
             <div class="row">
                 ...
                 @if (isset($students))
                     {!! Form::open(['url' => action('OtherFeeAllocationController@store'), 'method' => 'post', 'class' => '', '' . 'id' => 'store_student_fee', 'files' => true]) !!}
