...
<title>@lang('english.certificate')</title>
...
@foreach ( $certificate_issue as $issue )
    ...
    <div class="header">
        <h2 class="cursive bold" id="head" style="text-transform: capitalize">Birth Certificate</h2>
    </div>
   <div class="container ">
	   <div class="column">
	     <table width="100%" >
	   ...
	   <div class="column photo">
	                             @if (file_exists(public_path('uploads/student_image/' . $issue->student->student_image)))
                        <img width="100%" height="130" src="{{ url('uploads/student_image/' . $issue->student->student_image) }}" />
                        @else
    ...
    <div class="student-info">
       <div class="header">
        ...
        <div class='roww'>
            ...
            <div class='underline'>{{ strtoupper($issue->student->religion) }}</div>
            <div class='label mg-left'>@lang('english.roll_no'):</div>
            <div class='underline mg-left'>{{ strtoupper($issue->student->roll_no) }}</div>
            <div class='label mg-left'>@lang('english.gender'):</div>
            <div class="check mg-left">@if($issue->student->gender=='male')<span style="padding: 1px">&#10004;<span>@endif</div>
            <div class='mg-left'>@lang('english.male')</div>
            <div class="check mg-left">@if($issue->student->gender=='female')<span style="padding: 1px">&#10004;<span>@endif</div>
        ...
        <div class='roww'>
            <div class='underline'> a regular student of calss {{ $issue->student->current_class->title }}  in this institute. He / She  has good moral character.</div>
        </div>
