...
<div class="modal-dialog modal-lg" role="document">
    ...
    {!! Form::open(['url' => action('Examination\TermController@update', [$exam_term->id]), 'method' => 'PUT', 'id' => 'exam_term_edit_form' ]) !!}
        ...
        <p class="text-muted">Update Exam Term here. Please provide required information to proceed next...</p>
            <div class="form-group">
           {!! Form::label('exam_term', __( 'english.exam_term_name' ) . ':*') !!}
                {!! Form::text('name', $exam_term->@lang('english.name'), ['class' => 'form-control', 'required', 'placeholder' => __( 'english.exam_term_name' ) ]) !!}
            </div>
