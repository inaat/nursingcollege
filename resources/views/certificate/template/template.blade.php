        ...
        <div class="row">
            <div class="col-md-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">
                            {{ __('Create Certificate') . ' ' . __('Template') }}
                        </h4>
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-sm-12 col-md-4">
                                <label>{{ __('Page Layout') }} <span class="text-danger">*</span></label>
                            ...
                            <div class="form-group col-sm-12 col-md-4">
                                <label>{{ __('User Image Shape') }} <span class="text-danger">*</span></label>
                                {!! Form::select('user_image_shape', ['Round' => 'Round','Square' => 'Square'], 'Round', ['class' => 'form-control']) !!}
                            </div>

                            <div class="form-group col-sm-12 col-md-4">
                                <label>{{ __('Image Size') }} <span class="text-small text-info">({{ __('px') }})</span><span class="text-danger">*</span></label>
