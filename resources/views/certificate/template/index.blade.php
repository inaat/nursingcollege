...
<div class="page-wrapper">
    <div class="page-content">
        ...
        <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
            <div class="breadcrumb-title pe-3">@lang('Manage Your Certificate Template')</div>
            <div class="ps-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0">
                        <li class="breadcrumb-item"><a href="{{ url('/home') }} "><i class="bx bx-home-alt"></i></a>
                        </li>
                        <li class="breadcrumb-item active" aria-current="page">@lang('Certificate Template')</li>
                    </ol>
                </nav>
            </div>
        </div>
        ...
        <div class="card">
            <div class="card-body">
                <h5 class="card-title text-primary">@lang('List Certificate Template')</h5>
                ...
                <div class="table-responsive">
                    <table class="table mb-0" width="100%" id="certificate_template_table">
                        <thead class="table-light" width="100%">
                            <tr>
                                <th>@lang( 'english.action' )</th>
                                <th>@lang( 'english.name' )</th>
                                <th>@lang( 'english.type' )</th>
                                <th>@lang( 'Page Layout' )</th>
                                <th>@lang( 'Background Image ' )</th>
                                <th>@lang( 'Layout' )</th>
                            </tr>
                        </thead>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        var certificate_template_table = $('#certificate_template_table').DataTable({
            processing: true
            , serverSide: true
            , ajax: '/certificate-template'
            , columns: [{
                    data: "action"
                    , name: "action"
                    , orderable: false
                    ...
                    $.ajax({
                        ...
                        , success: function(result) {
                            if (result.success == true) {
                                ...
                                certificate_template_table.ajax.reload();
                            } else {
