...
<div class="page-wrapper">
    <div class="page-content">
        ...
        {!! Form::open(['url' => action('TeacherLayout\AssessmentController@store'), 'method' => 'post', 'class'=>'needs-validation was-validated','novalidate'.'id' =>'search_student_fee' ,'files' => true]) !!}
            ...
            <div class="card-body">
                ...
                <div class="row ">
                    ...
                    <div class="col-md-4 p-2 ">
                        {!! Form::label('english.student', __('english.students') . ':*') !!}
                        {!! Form::select('student_id', $students, null,['class' => 'form-select select2 ','style' => 'width:100%', 'required', 'placeholder' => __('english.please_select')]) !!}
                    </div>
