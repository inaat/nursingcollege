            ...
            <div class="card-body">
                ...
                <div class="row ">
                    ...
                    <div class="col-md-4 p-2">
                        ...
                        {!! Form::select('class_id',$classes,$class_id, ['class' => 'form-select teacher-classes ','style' => 'width:100%', 'required', 'placeholder' => __('english.please_select')]) !!}
                    </div>
                    <div class="col-md-4 p-2">
                        {!! Form::label('english.sections', __('english.sections') . ':*') !!}
                        {!! Form::select('class_section_id', $sections, $class_section_id, ['class' => 'form-select select2 teacher-class_section', 'required', 'style' => 'width:100%', 'placeholder' => __('english.please_select')]) !!}
                    </div>
                    ...
                    <div class="col-md-4 p-2">
                        ...
                        {!! Form::select('subject_id', $classSubject, $subject_id, ['class' => 'form-select select2 teacher-section-subjects', 'id' => 'global-section-subjects', 'style' => 'width:100%', 'placeholder' => __('english.please_select')]) !!}
                    </div>
                    <div class="col-md-4 p-2">
