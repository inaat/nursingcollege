    ...
    <div class="page-content">
        ...
        <div class="card">
            <div class="card-body">
                <div class="row">
                    <div class="col-md-3 ">
                        {!! Form::label('award', __( 'english.name' ) . ':*') !!}
                    ...
                    <div class="col-md-6 mt-2 ">
                     ...
                     <table id="table_id_table" class="table table-condensed table-striped "  width="100%">
                            ...
                            <th class="text-center">@lang('english.enable')</th>
                                  ...
                                  <tbody>
                        @foreach ( $class_sections as $student)

                        <tr>
                            <td class="text-left">
                                Class:{{ $student->classes->title }} Section {{ $student->section_name }}
                            </td>
                            <td class="text-center">
                                <input type="checkbox" id="student.{{ $student->id }}" class="common-checkbox form-check-input mt-2" name="class_section[]" value="{{ $student->id }}" }}>
