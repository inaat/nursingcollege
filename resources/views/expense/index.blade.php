...
@section('title', __('english.expense'))
 @section('wrapper')
 <div class="page-wrapper">
     <div class="page-content">
             ...
             <div class="card-body">
                 <div class="accordion" id="transaction-filter">
                     <div class="accordion-item">
                        ...
                        {!! Form::select('expense_category_id', $expense_categories, null,['class' => 'form-select select2','style' => 'width:100%', 'id' => 'expense_category_id','required', 'placeholder' => __('english.please_select')]) !!}
                    </div>
                                     <div class="col-md-4 p-1">
                                         {!! Form::label('vehicles', __('english.vehicles') . ':*') !!}
                                         {!! Form::select('vehicle_id', $vehicles, null, ['class' => 'form-select select2', 'required', 'id'=>'vehicle_id','style' => 'width:100%', 'required', 'placeholder' => __('english.all')]) !!}
                                     </div>
         ...
         <div class="card">
             <div class="card-body">
                 <h5 class="card-title text-primary">@lang('english.all_expense_transaction')</h5>
                @can('expense.create')
                 <div class="d-lg-flex align-items-center mb-4 gap-3">
                     <div class="ms-auto"><a class="btn btn-primary radius-30 mt-2 mt-lg-0" href="{{ action('ExpenseTransactionController@create') }}">
                             <i class="bx bxs-plus-square"></i>@lang('english.add_new_expense')</a></div>
                             @endcan
                 </div>
                 ...
                 <div class="table-responsive">
                     <table class="table mb-0" width="100%" id="expenses_transaction_table">
                         <thead class="table-light" width="100%">
                             <tr>
                                 ...
                                 <th>@lang('english.category_name')</th>
                                 <th>@lang('english.note')</th>
                                 <th>@lang('english.vehicle')</th>
