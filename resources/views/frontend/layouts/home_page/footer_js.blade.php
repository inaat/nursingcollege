<script src="{{ asset('newassets/home_page/js/script.js') }}"></script>


<!-- bootstrap  -->
{{-- <script src="https://cdnjs.cloudflare.com/ajax/libs/jquery/3.6.0/jquery.min.js"></script> --}}
<!-- fontawesome icons   -->
<script src="{{ asset('newassets/home_page/js/1d2a297b20.js') }}"></script>
<script src="{{ asset('/newassets/js/custom/common.js') }}"></script>
<script src="{{ asset('/newassets/js/custom/custom.js') }}"></script>
<script src="{{ asset('/newassets/js/custom/function.js') }}"></script>
<script src="{{ asset('/newassets/js/jquery.validate.min.js') }}"></script>

{{-- Sliders --}}
<script src="{{ asset('newassets/home_page/js/owl.carousel.min.js') }}"></script>

<script src="{{ asset('/newassets/js/sweetalert2.all.min.js') }}"></script>
...
<!-- bootstrap  -->
{{-- FAQs --}}
<script src="{{ asset('newassets/home_page/js/bootstrap.bundle.min.js') }}"> </script>
...
<script src="{{ asset('/newassets/jquery-toast-plugin/jquery.toast.min.js') }}"></script>
