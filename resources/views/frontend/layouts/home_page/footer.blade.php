        ...
        <div class="row">
            <div class="col-sm-6 col-md-6 col-lg-6">
                <div class="companyInfoWrapper">
                    <div>
                        <a href="{{ url('/') }}">
                            <img src="{{  url('uploads/front_image/' . session()->get('front_details.logo_image'))  ?? asset('newassets/landing_page_images/Logo1.svg') }}" class="logo" alt="">
                        </a>
                    </div>
                    <div>
                            ...
                            @if (isset($settings['facebook']))
                                <span class="iconsWrapper">
                                    <a href="{{ $settings['facebook'] }}" target="_blank">
                                        <span>
                                            <img src="{{ asset('newassets/landing_page_images/facebook.svg') }}" alt="">
                                        </span>
                                        <span>
                                            {{ __('facebook') }}
                                        </span>
                            ...
                            @if (isset($settings['instagram']))
                                <span class="iconsWrapper">
                                    <a href="{{ $settings['instagram'] }}" target="_blank">
                                        <span>
                                            <img src="{{ asset('newassets/landing_page_images/instagram.svg') }}" alt="">
                                        </span>
                                        <span>
                                            {{ __('instagram') }}
                                        </span>
                            ...
                            @if (isset($settings['linkedin']))
                                <span class="iconsWrapper">
                                    <a href="{{ $settings['linkedin'] }}" target="_blank">
                                        <span>
                                            <img src="{{ asset('newassets/landing_page_images/linkedin1.svg') }}" alt="">
                                        </span>
                                        <span>
                                            {{ __('linkedin') }}
                                        </span>
