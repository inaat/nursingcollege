        ...
        <div class="row">
            ...
            <div class="col-sm-6 col-md-6 col-lg-3">
                <div class="companyInfoWrapper">
                    ...
                    <div class="socialIcons">
                        ...
                        @if ($schoolSettings['youtube'] ?? '')
                            <span>
                                <a href="{{ $schoolSettings['youtube'] }}" target="_blank">
            ...
            <div class="col-sm-6 col-md-6 col-lg-3">
                <div class="linksWrapper usefulLinksDiv">
                    ...
                    <span><a href="{{ url('about-us') }}">About Us</a></span>
                    <span><a href="{{ url('photos') }}">Photos</a></span>
                    <span><a href="{{ url('videos') }}">Videos</a></span>
            ...
            <div class="col-sm-6 col-md-6 col-lg-2">
                <div class="linksWrapper">
                    ...
                    <span>
                        <a href="{{ url('terms-conditions') }}"> Terms & Conditioins </a>
                    </span>
                    <span>
                    ...
                    <span>
                        {{-- <a href="{{ url('refund-cancellation-policy') }}"> Refund - Cancellation </a> --}}
                    </span>
                </div>
            </div>
