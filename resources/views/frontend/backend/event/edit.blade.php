 ...
 <div class="page-wrapper">
     <div class="page-content">
         ...
         <div class="card">
             <div class="card-body">
                 {!! Form::open(['url' => action('Frontend\FrontEventController@update',[$event->id]), 'method' => 'PUT', 'id' =>'weekend_holiday_add_form' ,'files' => true]) !!}
 
                 <div class="row">
                     <div class="col-md-4 p-3">
                         {!! Form::label('name', __('english.event_title' ) . ':*') !!}
                         {!! Form::text('title',$event->title, ['class' => 'form-control', 'required', 'placeholder' => __('english.event_title' )]) !!}
                     </div>
                    
                     <div class="col-md-4 p-3">
                        {!! Form::label('from', __('english.from' ) . ':') !!}
                        {!! Form::text('from',@format_date($event->from), ['class' => 'form-control date-picker', 'readonly', 'placeholder' => __('english.from')]) !!}
                    </div>
                    <div class="col-md-4 p-3">
                        {!! Form::label('to', __('english.to' ) . ':') !!}
                        {!! Form::text('to',@format_date($event->to), ['class' => 'form-control date-picker', 'readonly', 'placeholder' => __('english.to')]) !!}
                    </div>
                     ...
                     <div class="col-md-12 p-3">
                         ...
                         {!! Form::textarea('description',$event->description, ['class' => 'form-control', 'id'=>'description','placeholder' => __('english.description' )]) !!}
                     </div>
                 </div>
