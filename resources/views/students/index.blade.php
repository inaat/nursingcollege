                     ...
                     <div class="accordion-item">
                         ...
                         <div id="collapseOne" class="accordion-collapse collapse" aria-labelledby="student-fillter" data-bs-parent="#student-fillter" style="">
                             <div class="accordion-body">
                                 {!! Form::open(['url' => action('StudentController@bulkform'), 'method' => 'post']) !!}
                                 <div class="row">
                                     ...
                                     <div class="col-md-4 p-1">
                                         ...
                                         {!! Form::select('batch_id', $batches, $batch_id, ['class' => 'form-select select2 global-batch', 'id' => 'students_list_filter_batch_id', 'required', 'style' => 'width:100%', 'required', 'placeholder' => __('english.all')]) !!}
                                     </div>
                                     <div class="col-md-4 p-1">
                                         {!! Form::label('english.semesters', __('english.semesters') . ':*') !!}
                                         {!! Form::select('semester_id', $semesters, $semester_id, ['class' => 'form-select select2 global-batch', 'id' => 'students_list_filter_semester_id', 'required', 'style' => 'width:100%', 'required', 'placeholder' => __('english.all')]) !!}
                                     </div>
                                     <div class="col-md-4 p-1">
                                     ...
                                     <div class="col-md-3 p-1">
                                         ...
                                         {!! Form::select('vehicle_id', $vehicles, null, ['class' => 'form-control select2 ','id'=>'students_list_filter_vehicle_id','placeholder' => __('english.please_select') ]) !!}
                                     </div>
                                     <div class="col-md-3 p-1">
                                     ...
                                     <div class="col-md-3 p-1">
                                        ...
                                        {!! Form::select("gender", ['male' => __('english.male'), 'female' => __('english.female'), 'others' => __('english.others')],null, ['class' => 'form-select  ','id' => 'students_list_filter_gender', 'style' => 'width:100%',  'placeholder' => __('english.please_select')]) !!}
                                     ...
                                     <div class="col-md-3 p-1">
                                         {!! Form::label('form_type', __('english.form_type') . ':*') !!}
                                         {!! Form::select('form_type', ['pnc' => 'PNC Form', 'kmu' => 'KMU Form'], null, ['class' => 'form-select select2', 'required', 'id' => 'form_type', 'style' => 'width:100%', 'placeholder' => __('english.please_select')]) !!}
                                     </div>
                                     <div class="col-md-3 p-1">
                                         <div class="mt-4">
                                            <button type="submit" class="btn btn-success" id="print_forms">
                                                 <i class="bx bx-printer"></i> Print Forms
                                             </button>
                                         </div>
                                     </div>
                                 </div>
