...
<div class="page-wrapper">
                    ...
                    <div class="col-md-10">
                        <div class="row">
                            ...
                            <div class="col-md-3 p-1">
                               ...
                               <div class="col-md-3 p-1">
                                         {!! Form::label('english.batches', __('english.batches') . ':*') !!}
                                         {!! Form::select('batch_id', $batches, $student->batch_id, ['class' => 'form-select select2 global-batch', 'id' => 'students_list_filter_batch_id', 'required', 'style' => 'width:100%', 'required', 'placeholder' => __('english.all')]) !!}
                                     </div>
                                     <div class="col-md-3 p-1">
                                         {!! Form::label('english.semesters', __('english.semesters') . ':*') !!}
                                         {!! Form::select('semester_id', $semesters, $student->semester_id, ['class' => 'form-select select2 global-batch', 'id' => 'students_list_filter_semester_id', 'required', 'style' => 'width:100%', 'required', 'placeholder' => __('english.all')]) !!}
                                     </div>
                            <div class="col-md-3 p-1">
                ...
                <div class="row pt-4">
                    ...
                    <div class="row ">
                     ...
                     <div class="col-md-3 p-1">
                        ...
                        {!! Form::text('student_tuition_fee', @num_format($student->student_tuition_fee), ['class' => 'form-control input_number', 'required','placeholder' => __('english.student_tuition_fee'),'id' => 'student_tuition_fee']) !!}
                    </div>
                      <div class="col-md-3 p-1">
                        {!! Form::label('english.discount_type', __('english.discount_type') . ':*') !!}
                        {!! Form::select('discount_type', ['fixed' => __('english.fixed'), 'percentage' => __('english.percentage')],$student->discount_type, ['class' => 'form-select select2 ', 'id'=>'discount_type', 'style' => 'width:100%', 'placeholder' => __('english.please_select')]) !!}
                    </div>

                         <div class="col-md-3 p-1">
                        {!! Form::label('english.discount_per', __('english.discount') . ':*') !!}
                        {!! Form::text('discount_per', @num_format($student->discount_per), ['class' => 'form-control input_number', 'required ','placeholder' => __('english.discount'),'id' => 'student_discount_per']) !!}
                    </div>
                    <div class="col-md-3 p-1">
                        {!! Form::label('english.student_transport_fee', __('english.student_transport_fee') . ':*') !!}
                        {!! Form::text('student_transport_fee', @num_format($student->student_transport_fee), ['class' => 'form-control input_number', 'required','placeholder' => __('english.student_transport_fee'),'id' => 'student_transport_fee']) !!}
                    </div>
 ...
 <div class="row p-2">
    <h5 class="card-title text-primary">@lang('english.educational_qualifications')</h5>
        ...
        <div class="table-responsive">
            <table class="table table-bordered">
                <thead class="table-primary">
                    <tr>
                        <th>@lang('english.qualification')</th>
                        <th>@lang('english.passing_year')</th>
                        <th>@lang('english.marks_obtained')</th>
                        <th>@lang('english.total_marks')</th>
                        <th>@lang('english.percentage')</th>
                        <th>@lang('english.biology_marks')</th>
                        <th>@lang('english.board')</th>
                    </tr>
                </thead>
                <tbody>
                    @if($student->qualifications->count() > 0)
                        @foreach ($student->qualifications as $qualification)
                            <tr>
                                <td>
                                    <input type="hidden" name="qualifications[{{$qualification->id}}][id]" value="{{$qualification->id}}">
                                    <input type="text" name="qualifications[{{$qualification->id}}][qualification]" 
                                        class="form-control" readonly value="{{$qualification->qualification}}">
                                </td>
                             <td>
    {!! Form::number('qualifications[' . $qualification->id . '][passing_year]', $qualification->passing_year, [
        'class' => 'form-control',
        'placeholder' => '2020',
    ]) !!}
</td>
<td>
    {!! Form::number('qualifications[' . $qualification->id . '][marks_obtained]', $qualification->marks_obtained, [
        'class' => 'form-control',
        'placeholder' => '850',
    ]) !!}
</td>
<td>
    {!! Form::number('qualifications[' . $qualification->id . '][total_marks]', $qualification->total_marks, [
        'class' => 'form-control',
        'placeholder' => '1100',
    ]) !!}
</td>
<td>
    {!! Form::number('qualifications[' . $qualification->id . '][percentage]', $qualification->percentage, [
        'class' => 'form-control',
        'placeholder' => '77.27',
        'step' => '0.01',
    ]) !!}
...
<td>
    {!! Form::number('qualifications[' . $qualification->id . '][biology_marks]', $qualification->biology_marks, [
        'class' => 'form-control',
        'placeholder' => '85',
    ]) !!}
</td>
<td>
    {!! Form::text('qualifications[' . $qualification->id . '][board]', $qualification->board, [
        'class' => 'form-control',
        'placeholder' => 'Federal Board',
                    ...
                    @else
                        <tr>
                            <td>
                                <input type="text" class="form-control" value="Matriculation" readonly>
                                <input type="hidden" name="qualifications[0][qualification]" value="Matriculation">
                            </td>
                            <td>
                                {!! Form::number('qualifications[0][passing_year]', null, [
                                    'class' => 'form-control',
                                    'placeholder' => '2020',
                                ]) !!}
                            </td>
                            <td>
                                {!! Form::number('qualifications[0][marks_obtained]', null, [
                                    'class' => 'form-control',
                                    'placeholder' => '850',
                                ]) !!}
                            </td>
                            <td>
                                {!! Form::number('qualifications[0][total_marks]', null, [
                                    'class' => 'form-control',
                                    'placeholder' => '1100',
                                ]) !!}
                            </td>
                            <td>
                                {!! Form::number('qualifications[0][percentage]', null, [
                                    'class' => 'form-control',
                                    'placeholder' => '77.27',
                                    'step' => '0.01',
                                ]) !!}
                            ...
                            <td>
                                {!! Form::number('qualifications[0][biology_marks]', null, [
                                    'class' => 'form-control',
                                    'placeholder' => '85',
                                ]) !!}
                            </td>
                            <td>
                                {!! Form::text('qualifications[0][board]', null, [
                                    'class' => 'form-control',
                                    'placeholder' => 'Federal Board',
                                ]) !!}
                            </td>
                        ...
                        <tr>
                            <td>
                                <input type="text" class="form-control" value="F.Sc" readonly>
                                <input type="hidden" name="qualifications[1][qualification]" value="F.S.c">
                            </td>
                            <td>
                                {!! Form::number('qualifications[1][passing_year]', null, [
                                    'class' => 'form-control',
                                    'placeholder' => '2022',
                                ]) !!}
                            </td>
                            <td>
                                {!! Form::number('qualifications[1][marks_obtained]', null, [
                                    'class' => 'form-control',
                                    'placeholder' => '920',
                                ]) !!}
                            </td>
                            <td>
                                {!! Form::number('qualifications[1][total_marks]', null, [
                                    'class' => 'form-control',
                                    'placeholder' => '1100',
                                ]) !!}
                            </td>
                            <td>
                                {!! Form::number('qualifications[1][percentage]', null, [
                                    'class' => 'form-control',
                                    'placeholder' => '83.64',
                                    'step' => '0.01',
                                ]) !!}
                            ...
                            <td>
                                {!! Form::number('qualifications[1][biology_marks]', null, [
                                    'class' => 'form-control',
                                    'placeholder' => '95',
                                ]) !!}
                            </td>
                            <td>
                                {!! Form::text('qualifications[1][board]', null, [
                                    'class' => 'form-control',
                                    'placeholder' => 'Federal Board',
                                ]) !!}
                            </td>
