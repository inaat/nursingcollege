    ...
    <div class="page-content">
            ...
            <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 p-1">
                               ...
                               <div class="col-md-3 p-1">
                                         ...
                                         {!! Form::select('batch_id', $batches, null, ['class' => 'form-select select2 global-batch', 'id' => 'students_list_filter_batch_id', 'required', 'style' => 'width:100%', 'required', 'placeholder' => __('english.all')]) !!}
                                     </div>
                                     <div class="col-md-3 p-1">
                                         {!! Form::label('english.semesters', __('english.semesters') . ':*') !!}
                                         {!! Form::select('semester_id', $semesters, null, ['class' => 'form-select select2 global-batch', 'id' => 'students_list_filter_semester_id', 'required', 'style' => 'width:100%', 'required', 'placeholder' => __('english.all')]) !!}
                                     </div>
                            <div class="col-md-3 p-1">
                            ...
                            <div class="col-md-3 p-1">
                                ...
                                {!! Form::select('gender', ['male' => __('english.male'), 'female' => __('english.female'), 'others' => __('english.others')],'male', ['class' => 'form-select select2 ','required', 'style' => 'width:100%', 'required', 'placeholder' => __('english.please_select')]) !!}
                            </div>
                            <div class="col-md-3 p-1">
                ...
                <div class="row pt-4  remove ">
                 ...
                 <div class="row pt-4  remove">
                    ...
                    <div class="col-md-3 p-1   {{!empty(session()->get('system_details.common_settings')['address']) ? '' : 'hide'}}">
                        {!! Form::label('country_id', __('english.country_name') . ':*') !!}
                        {!! Form::select('country_id',$countries,!empty(session()->get('system_details.common_settings')['country_id'])
        ...
        : null, ['class' => 'form-select select2 ','required','id'=>'country_id', 'style' => 'width:100%', 'required', 'placeholder' => __('english.please_select')]) !!}
                    ...
                    <div class="col-md-3 p-1 {{!empty(session()->get('system_details.common_settings')['address']) ? '' : 'hide'}}">
                        ...
                        {!! Form::select('province_id',$provinces,!empty(session()->get('system_details.common_settings')['country_id'])
        ? session()->get('system_details.common_settings')['country_id']
        : null, ['class' => 'form-select select2 ','required', 'style' => 'width:100%', 'required','id' => 'provinces_ids','placeholder' => __('english.please_select')]) !!}
                    ...
                    <div class="col-md-3 p-1 {{!empty(session()->get('system_details.common_settings')['address']) ? '' : 'hide'}}">
                        ...
                        {!! Form::select('district_id',$districts,!empty(session()->get('system_details.common_settings')['province_id'])
        ...
        : null, ['class' => 'form-select select2 ','required', 'style' => 'width:100%', 'required','id' => 'district_ids','placeholder' => __('english.district_name')]) !!}
                    ...
                    <div class="col-md-3 p-1 {{!empty(session()->get('system_details.common_settings')['address']) ? '' : 'hide'}}">
                        ...
                        {!! Form::select('city_id',$cities,!empty(session()->get('system_details.common_settings')['city_id'])
        ...
        : null, ['class' => 'form-select select2 ','required', 'style' => 'width:100%', 'required','id' => 'city_ids','placeholder' => __('english.city_name')]) !!}
                    ...
                    <div class="col-md-3 p-1 {{!empty(session()->get('system_details.common_settings')['address']) ? '' : 'hide'}}">
                        ...
                        {!! Form::select('region_id',$regions,!empty(session()->get('system_details.common_settings')['region_id'])
        ? session()->get('system_details.common_settings')['region_id']
                ...
                <div class="row pt-4">
                    ...
                    <div class="row ">
                     ...
                     <div class="col-md-3 p-1">
                        ...
                        {!! Form::text('student_tuition_fee', null, ['class' => 'form-control input_number', 'required','placeholder' => __('english.student_tuition_fee'),'id' => 'student_tuition_fee']) !!}
                    </div>
                      <div class="col-md-3 p-1">
                        {!! Form::label('english.discount_type', __('english.discount_type') . ':*') !!}
                        {!! Form::select('discount_type', ['fixed' => __('english.fixed'), 'percentage' => __('english.percentage')],'fixed', ['class' => 'form-select select2 ', 'id'=>'discount_type', 'style' => 'width:100%', 'placeholder' => __('english.please_select')]) !!}
                    </div>
                         <div class="col-md-3 p-1">
                        {!! Form::label('english.discount_per', __('english.discount') . ':*') !!}
                        {!! Form::text('discount_per', null, ['class' => 'form-control input_number', 'required ','placeholder' => __('english.discount'),'id' => 'student_discount_per']) !!}
                    </div>
                    <div class="col-md-3 p-1">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>
                                            ...
                                            <input type="hidden" name="qualifications[0][qualification]"
                                                value="Matriculation">
                                        </td>
                                        <td>
