                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="col-md-12 p-1">
                                        {!! Form::select("marks[" . $std->id . "][gender]", ['male' => __('english.male'), 'female' => __('english.female'), 'others' => __('english.others')],$std->gender, ['class' => 'form-select ','required', 'style' => 'width:100%', 'required', 'placeholder' => __('english.please_select')]) !!}
                                ...
                                <td>
                                    <div class="col-md-12 p-1">
                                        {!! Form::select("marks[" . $std->id . "][batch_id]", $batches,$std->batch_id, ['class' => 'form-select ','required', 'style' => 'width:100%', 'required', 'placeholder' => __('english.please_select')]) !!}
                                ...
                                <td>
                                    <div class="col-md-12 p-1">
                                        {!! Form::select("marks[" . $std->id . "][semester_id]", $semesters,$std->semester_id, ['class' => 'form-select ','required', 'style' => 'width:100%', 'required', 'placeholder' => __('english.please_select')]) !!}
