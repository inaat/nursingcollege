...
@section('title', __('english.promotion'))
@section('wrapper')
<div class="page-wrapper">
    <div class="page-content">
        <!--breadcrumb-->
        <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
            <div class="breadcrumb-title pe-3">@lang('english.Promotion')</div>
            <div class="ps-3">
        ...
        <!--end breadcrumb-->
        {!! Form::open(['url' => action('Examination\PromotionController@getStudentList'), 'method' => 'post', 'id' =>'promotion-list-form']) !!}
            ...
            <div class="card-body">
                ...
                <div class="row m-0">
                    ...
                    <div class="col-md-3 p-1">
                        ...
                        {!! Form::select('batch_id', $batches, $batch_id, ['class' => 'form-select select2 global-batch', 'id' => 'filter_batch_id', 'required', 'style' => 'width:100%', 'required', 'placeholder' => __('english.all')]) !!}
                    </div>
                    <div class="col-md-3 p-1">
                        {!! Form::label('english.semesters', __('english.semesters') . ':*') !!}
                        {!! Form::select('semester_id', $semesters,$semester_id, ['class' => 'form-select select2 global-semester', 'id' => 'filter_semester_id', 'required', 'style' => 'width:100%', 'required', 'placeholder' => __('english.all')]) !!}
                    </div>
                    <div class="col-md-3 p-2">
        ...
        <div class="row">
            ...
            @if (isset($students))
            {!! Form::open(['url' => action('Examination\PromotionController@store'), 'method' => 'post', 'class' => '', '' . 'id' => 'promote-students']) !!}
            <div class="row">
                ...
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        <div class="card-body">
                                                ...
                                                <h6 class="card-title text-primary">@lang('english.promote_students_in_next_session')</h6>
                      <hr>

                            <div class="table-responsive">
                             <div class="row m-0">
                         <div class="col-md-3 p-1">
                               {!! Form::label('english.sessions', __('Promote In Session') . ':*') !!}
                               {!! Form::select('session_id',$sessions,null, ['class' => 'form-select select2  ','required', 'style' => 'width:100%', 'required', 'placeholder' => __('english.please_select'),'id'=>'session_id']) !!}
                       </div>
                    <div class="col-md-3 p-2 ">
                        {!! Form::label('english.student', __('english.campuses') . ':*') !!}
                        {!! Form::select('campus_id', $campuses,null, ['class' => 'form-select select2 promote-campuses', 'required', 'style' => 'width:100%', 'required', 'placeholder' => __('english.please_select')]) !!}
                    </div>
                   <div class="col-md-3 p-2">
                            {!! Form::label('english.classes', __('english.classes') . ':*') !!}
                            {!! Form::select('class_id', [], null, ['class' => 'form-select select2 promote-classes', 'required', 'style' => 'width:100%', 'required', 'placeholder' => __('english.please_select')]) !!}
                        </div>
                        <div class="col-md-3 p-1">
                            {!! Form::label('english.batches', __('english.batches') . ':*') !!}
                            {!! Form::select('batch_id', $batches, null, ['class' => 'form-select select2 global-batch', 'id' => 'filter_batch_id', 'required', 'style' => 'width:100%', 'required', 'placeholder' => __('english.all')]) !!}
                        </div>
                        <div class="col-md-3 p-1">
                            {!! Form::label('english.semesters', __('english.semesters') . ':*') !!}
                            {!! Form::select('semester_id', $semesters,null, ['class' => 'form-select select2 global-semester', 'id' => 'filter_semester_id', 'required', 'style' => 'width:100%', 'required', 'placeholder' => __('english.all')]) !!}
                        </div>
                        <div class="col-md-3 p-2">
                            {!! Form::label('english.sections', __('english.sections') . ':*') !!}
                            {!! Form::select('class_section_id', [], null, ['class' => 'form-select select2 promote-class_sections' ,'required', 'id' => 'students_list_filter_class_section_id', 'style' => 'width:100%', 'placeholder' => __('english.please_select')]) !!}
                        </div>
                                ...
                                <table class="table mb-0" width="100%" id="students_table">
                                    <thead class="table-light" width="100%">
                                        <tr>
                                            ...
                                            <th>@lang('english.current_result')</th>
                                    ...
                                    <tbody class="">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                @if ( $student->final_percentage>=40)
                                                <div class="form-check">
                                                    <input class="form-check-input" type="checkbox" value="" id="flexCheckCheckedDisabled" checked="" disabled="">
                                                    <label class="form-check-label" for="flexCheckCheckedDisabled">Pass</label>
                                                </div>
                                                @else
                                                <div class="form-check">
                                                    <input class="form-check-input" type="checkbox" value="" id="flexCheckCheckedDisabled" disabled="">
                                                    <label class="form-check-label" for="flexCheckCheckedDisabled">Fail</label>
                                                </div>
                                                @endif
