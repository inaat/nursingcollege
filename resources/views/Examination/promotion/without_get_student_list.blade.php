...
@section('title', __('english.promotion_without_exam'))
@section('wrapper')
<div class="page-wrapper">
    <div class="page-content">
        <!--breadcrumb-->
        <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
            <div class="breadcrumb-title pe-3">@lang('english.promotion_without_exam')</div>
            <div class="ps-3">
        ...
        <!--end breadcrumb-->
        {!! Form::open(['url' => action('Examination\PromotionController@withoutGetStudentList'), 'method' => 'post', 'id' =>'promotion-list-form']) !!}
        ...
        <div class="row">
            ...
            @if (isset($students))
            {!! Form::open(['url' => action('Examination\PromotionController@withoutExamPromotion'), 'method' => 'post', 'class' => '', '' . 'id' => 'promote-students']) !!}
            <div class="row">
