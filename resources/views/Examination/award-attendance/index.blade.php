...
@section('title', __('english.exam_award_list_attendance_print'))
@section('wrapper')
    <div class="page-wrapper">
        <div class="page-content">
            <!--breadcrumb-->
            <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
                <div class="breadcrumb-title pe-3">@lang('english.award_attendance_list_print')</div>
                <div class="ps-3">
                ...
                <div class="card-body">
                    ...
                    <div class="d-lg-flex align-items-center mt-4 gap-3">
                        <div class="ms-auto"><a class="btn btn-primary radius-30 mt-2 mt-lg-0 exam-print-invoice"
                                type="button"  href="#" data-href="{{ action('Examination\AwardAttendanceController@print') }}">
