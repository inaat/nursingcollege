...
@section('title', __('english.missing_subjects_in_this_exam'))
@section('wrapper')
    <div class="page-wrapper">
        <div class="page-content">
            <!--breadcrumb-->
            <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
                <div class="breadcrumb-title pe-3">@lang('english.missing_subjects_in_this_exam')</div>
                <div class="ps-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            <li class="breadcrumb-item"><a href="{{ url('/home') }} "><i class="bx bx-home-alt"></i></a>
                            </li>
                            <li class="breadcrumb-item active" aria-current="page">@lang('english.missing_subjects_in_this_exam')</li>
                        </ol>
                    </nav>
                </div>
            </div>
            ...
            <div class="row">
                ...
                @if (isset($missing_subjects))
                        {!! Form::open(['url' => action('Examination\ExamSetupController@postMissingSubjects'), 'method' => 'POST', 'id' => 'store_subject_fee' ]) !!}
                    <div class="row">
                                ...
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table class="table mb-0" width="100%" id="missing_subjects_table">
                                            ...
                                            <tbody class="">
                                            @foreach ($missing_subjects as $missing_subject) 

                                                @foreach ($missing_subject as $subject)
                                                    <tr>
                                                        <td>
