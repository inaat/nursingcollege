...
<body >
    ...
    <div style="height: 70px;">
        ...
        <h6 style="width:30%; margin:0 auto;text-align: center;border:1px solid black;        ">@lang('english.routine_test') @lang('english.subject_marks') </h6>
        <p class="right">
            @lang('english.examination') <span style="width:150px;text-align:center;border-bottom:1px solid black;display: inline-block; ">{{  $subs[0]->date }}({{ $subs[0]->session->title }})</span>
            <br>
            <br>
