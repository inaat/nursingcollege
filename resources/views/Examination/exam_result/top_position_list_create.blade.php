...
@section('title', __('english.top_position_list'))
 @section('wrapper')
     <div class="page-wrapper">
         <div class="page-content">
             <!--breadcrumb-->
             <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
                 <div class="breadcrumb-title pe-3">@lang('english.top_position_list')</div>
                 <div class="ps-3">
             ...
             <!--end breadcrumb-->
        {!! Form::open(['url' => action('Examination\ExamResultController@topPositionListStore'), 'method' => 'post', 'id' =>'top-position-print-form' ]) !!}
                 ...
                 <div class="card-body">
                     ...
                     <div class="row m-0">
                         ...
                         <div class="col-md-3 p-2">
                             ...
                             {!! Form::select('type', ['class_wise'=>'Class Wise','section_wise'=> 'Section Wise'], null, ['class' => 'form-select select2 type', 'required', 'style' => 'width:100%', 'required', 'placeholder' => __('english.please_select')]) !!}
                         </div>
