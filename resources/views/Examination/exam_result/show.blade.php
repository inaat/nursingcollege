...
<style>
  ...
  right: 0;
  z-index: -1;
  background: url({{ url('/uploads/invoice_logo/watermark.jpeg') }}) 0 0 repeat;
	...
	<div class="container ">
	   <div class="column">
	     <table width="100%" >
             <thead>
             <tr>
             <th><div class="underline text-align-center">@lang('english.roll_no')</div></th>
             <td ><div class="underline text-align-center"><strong>{{ ucwords($details->student->roll_no) }}</strong> </div></td>
             </tr>
             <tr>
             <th><div class="underline text-align-center">@lang('english.name')</div></th>
             <td ><div class="underline text-align-center"><strong>{{ ucwords($details->student->first_name . ' ' . $details->student->last_name) }}</strong> </div></td>
             </tr>
             <tr>
             <th><div class="underline text-align-center">@lang('english.s/d_of')</div></th>
             <td ><div class="underline text-align-center"><strong>{{ ucwords($details->student->father_name) }}</strong> </div></td>
             </tr>
             <tr>
             <th><div class="underline text-align-center">@lang('english.class')</div></th>
             <td ><div class="underline text-align-center"><strong>{{ ucwords($details->current_class->title) . ' '.$details->current_class_section->section_name }}</strong> </div></td>
             </tr>
             </thead>
         </table>
	   </div>
	   <div class="column">
             ...
             <thead>
             <tr>
             <th><div class="underline text-align-center">@lang('english.examination')</div></th>
             <td ><div class="underline text-align-center"><strong>{{ ucwords($details->exam_create->term->name) }}</strong> </div></td>
             </tr>
             <tr>
             <th><div class="underline text-align-center">@lang('english.session')</div></th>
             <td ><div class="underline text-align-center"><strong>{{ ucwords($details->session->title)}}</strong> </div></td>
             </tr>
             <tr>
             <th><div class="underline text-align-center">@lang('english.position_in_section')</div></th>
             <td ><div class="underline text-align-center"><strong>{{ $nf->format($details->class_section_position) }}</strong> </div></td>
             </tr>
             <tr>
             <th><div class="underline text-align-center">@lang('english.position_in_class')</div></th>
             <td ><div class="underline text-align-center"><strong>{{ $nf->format($details->class_position) }}</strong> </div></td>
             </tr>
             </thead>
         </table>
	   </div>
...
<div>
  	...
  	<div class="grid " style="border-bottom:1px solid #000;margin-top:5px;">
	   <div class="bottom-column">
	     <table width="100%" >
             ...
             <td ><div class="underline text-align-center"> {{ Auth::User()->first_name}}  {{ Auth::User()->last_name }}</div></td>
             </tr>
             <tr>
  ...
  <table width="100%" >
             ...
             <td ><div class="underline text-align-center"><strong>{{ @num_format($details->final_percentage) }}%</strong> </div></td>
             </tr>
             <tr>
             ...
             <tr>
             <th><div class=" text-align-center2">@lang('english.remarks'):</div></th>
