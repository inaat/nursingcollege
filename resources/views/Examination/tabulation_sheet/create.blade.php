            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-md-3 p-1">
                      ...
                      <div class="col-md-4 ">
                        {!! Form::label('print','Chose To Print') !!}
                        {!! Form::select('mat',['without_position'=>'Without Position','with_position'=>'With Position'],null, ['class' => 'form-select select2  mat', 'style' => 'width:100%', 'placeholder' => __('english.please_select')]) !!}
