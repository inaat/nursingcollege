           ...
           <div class="modal-body">
                   <div class="row ">
                       ...
                       <div class="col-md-4 p-1">
                        ...
                        {!! Form::select('batch_id', $batches, $date_sheet->batch_id, ['class' => 'form-select select2 global-batch', 'id' => 'students_list_filter_batch_id', 'required', 'style' => 'width:100%', 'required', 'placeholder' => __('english.all')]) !!}
                    </div>
                    <div class="col-md-4 p-1">
                        {!! Form::label('english.semesters', __('english.semesters') . ':*') !!}
                        {!! Form::select('semester_id', $semesters, $date_sheet->semester_id, ['class' => 'form-select select2 global-batch', 'id' => 'students_list_filter_semester_id', 'required', 'style' => 'width:100%', 'required', 'placeholder' => __('english.all')]) !!}
                    </div>
                           <div class="col-md-4 p-1">
