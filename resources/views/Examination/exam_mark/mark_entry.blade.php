...
<div class="page-wrapper">
    <div class="page-content">
        ...
        {!! Form::open(['url' => action('Examination\ExamMarkController@store'), 'method' => 'post', 'class'=>'needs-validation was-validated','novalidate'.'id' =>'search_student_fee' ,'files' => true]) !!}
                ...
                <table style="zoom:80%"id="pos_table" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                    ...
                    <tbody id="fn_mark">
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" name="marks[{{$loop->iteration}}][obtain_theory_mark]" class="form-control obtain_theory_mark tabkey addtabkey input_number" value="{{@num_format($data->obtain_theory_mark)}}" data-rule-max-value="{{$data->theory_mark}}" data-msg-max-value="{{__('english.minimum_value_error_msg', ['value' => @num_format($data->theory_mark)])}}">
                            </td>
                            @endif
                            @if($data->parc_mark>0)
                            ...
                            <td>
                                <input type="text" name="marks[{{$loop->iteration}}][obtain_parc_mark]" class="form-control obtain_parc_mark tabkey addtabkey input_number" value="{{@num_format($data->obtain_parc_mark)}}" data-rule-max-value="{{$data->parc_mark}}" data-msg-max-value="{{__('english.minimum_value_error_msg', ['value' => @num_format($data->parc_mark)])}}">
                            </td>
                            @endif
                            <td>
