     ...
     <div class="page-wrapper">
         <div class="page-content">
             ...
             <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
                 <div class="breadcrumb-title pe-3">sessionWiseExamResultPdf</div>
                 <div class="ps-3">
            ...
            {!! Form::open(['url' => action('Examination\ExamResultController@sessionWiseExamResultPdf'), 'method' => 'post', 'class'=>'needs-validation was-validated','novalidate'.'id' =>'search_student_fee' ,'files' => true]) !!}
                 ...
                 <div class="card-body">
                     ...
                     <div class="row ">
                       ...
                       <div class="col-md-4 p-2">
                        ...
                        {!! Form::select('exam_create_id[]',[],null, ['class' => 'form-select select2 exam_term_id', 'multiple' ,'style' => 'width:100%', 'placeholder' => __('english.please_select')]) !!}
                    </div>
                   </div>
