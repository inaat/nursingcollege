 ...
 @section('title', __('english.print'))
 @section('wrapper')
 <div class="page-wrapper">
     <div class="page-content">
         <!--breadcrumb-->
         {!! Form::open(['url' => action('NoteBookStatusController@noteBookPrint'), 'method' => 'post', 'id' =>'form']) !!}

         <div class="card">

             <div class="card-body">
                 <h6 class="card-title text-primary">@lang('english.note_book_status_report')</h6>
                 <hr>
                 <div class="row m-0">
                     <div class="col-md-3  ">
