                     ...
                     <div class="row">
                         <div class="col-md-12">
                             ...
                             <div class="border border-3 p-2 rounded">
                                 <span class="" style="  color: red;">Total Arrears:{{ @num_format($payment_line->amount) }}</span> <span class="blinking">{{ strtoupper($student_details->student_name .'('.$student_details->roll_no.')') }}</span><br />
                                 <div class="row payment_row p-2">
                                     ...
                                     <div class="col-md-6 p-1">
                                         ...
                                         <div class="input-group flex-nowrap"> <span class="input-group-text" id="addon-wrapping"><i class="fas fa-money-bill-alt"></i></span>
                                             {!! Form::text("amount", null, ['class' => 'form-control input_number amount tabkey', 'required','id' => 'account_amount', 'placeholder' => 'Amount']) !!}
                                 ...
                                 <button type="submit" class="btn btn-primary fee_due">Save</button>
                                     ...
                                     <div style="margin:20px;text-align: center;">
                                         ...
                                         <a class="btn btn-primary  print-bank-invoice " href="#" data-href="{{ action('VoucherController@singlePrint', [$fee_transaction->id]) }}"><i class="fas fa-print"></i> Bank Challan</a>
                                         @endcan
                                     </div>
                         ...
                         <table class="table table-bordered table-striped" id="payment_line_table">
                             <thead>
                                 <tr>
                                     ...
                                     <th>@lang('english.note')</th>
                                      <th>@lang('english.payment_ref_no')</th>
                             ...
                             <tbody>
                                 ...
                                 <tr>
                                     ...
                                     <td>
                                      @can('print.challan_print')
                                         <a class="btn btn-primary btn-xs  print-invoice " href="#" data-href="{{ action('SchoolPrinting\FeeCardPrintController@receiptPrint', [$payment->id]) }}"><i class="fas fa-print" aria-hidden="true" ></i></a>
                                         @endcan
                                         &nbsp;
