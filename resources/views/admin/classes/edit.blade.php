        ...
        <div class="modal-body">
            <div class="row">
                <div class="col-md-6 p-3">
                    ...
                    {!! Form::text('title', $classes->title, ['class' => 'form-control', 'required', 'placeholder' => __('english.title')]) !!}
                ...
                <div class="col-md-4 mt-4 ">
                             <input class="form-check-input big-checkbox" id="only_transport" name="only_transport" type="checkbox" value="0">
                        <label for="only_transport" class="control-label mt-2 ">Student Tuition Fee Also Update</label>
