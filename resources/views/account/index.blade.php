                                      ...
                                      <div class="table-responsive">
                                          <table class="table mb-0" id="account_types_table">
                                              <thead>
                                                  <tr>
                                                      <th>@lang( 'english.name' )</th>
                                                      <th>@lang('english.debit_increases')</th>
                                                      <th>@lang('english.credit_increases')</th>
                                              ...
                                              <tbody>
                                                  ...
                                                  <tr class="account_type_{{ $account_type->id }}">
                                                      ...
                                                      <td>{{ $account_type->debit_increases ? __('english.yes') : __('english.no') }}</td>
                                                      <td>{{ $account_type->credit_increases ? __('english.yes') : __('english.no') }}</td>
