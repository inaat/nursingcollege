        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="d-lg-flex align-items-center mb-4 gap-3">
                    <div class="ms-auto"><a class="btn btn-primary radius-30 mt-2 mt-lg-0 btn-slider-modal" href="#" data-href="{{ action('SliderController@create') }}" data-container=".slider_modal">
