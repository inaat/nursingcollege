...
<body>
    ...
    <div class="page print_area" size="A4" id="page">
        ...
        <div class="student-info">
            ...
            <div class='row'>
                <div class='label'>@lang('english.date_of_birth')<small>({{ session('system_details.date_format', config('constants.default_date_format')) }})</small>:</small></div><span class="underline"></span>
                <!-- <div class='underline'></div> -->
        ...
        <div class="student-info-full">
            ...
            <div class='row'>
                ...
                <div class='underline'></div>
                <div class='label mg-left'>@lang('english.class'):</div>
                <div class='underline'></div>
            </div>
            <div class='row'>
