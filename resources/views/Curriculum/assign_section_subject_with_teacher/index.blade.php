                ...
                <div class="card-body">
                    ...
                    <div class="row ">
                        ...
                        <div class="col-md-4 p-1">
                            ...
                            {!! Form::select('semester_id', $semesters, null, ['class' => 'form-select select2 global-batch', 'id' => 'filter_semester_id', 'required', 'style' => 'width:100%', 'required', 'placeholder' => __('english.all')]) !!}
                        </div>
                    </div>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
          ...
          "data": function ( d ) {
                ...
                if ($('#filter_batch_id').length) {
                    d.batch_id = $('#filter_batch_id').val();
                }
                if ($('#filter_semester_id').length) {
                    d.semester_id = $('#filter_semester_id').val();
                }
                ...
                columns: [{
                ...
                }, 
                 {
                    ...
                    data: "campus_name",
                    name: "campus_name", orderable: false,searchable: false
                }, 
                 {
              
                    data: "class_name",
                    name: "class_name" , orderable: false,searchable: false
                },
                 {
              
                    data: "batch_name",
                    name: "batch_name" , orderable: false,searchable: false
                },
                 {
              
                    data: "semester_name",
                    name: "semester_name" , orderable: false,searchable: false
                },
                 {
              
                    data: "section_name",
                    name: "section_name" , orderable: false,searchable: false
                },
                 {
                    data: "action",
                    name: "action"
