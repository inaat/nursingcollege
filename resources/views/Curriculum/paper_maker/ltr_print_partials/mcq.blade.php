             ...
             <table style="border:none">
                 <tbody>
                     <tr class="tr1">
                         ...
                         <td colspan="4" class=" td1 QuestHead" contenteditable="true" style="text-align:right;font-weight:bold !important;font-family:Jameel Noori Nastaleeq;">
         ...
         <tbody>
             <tr class="tr1 mcqstable">
                 <td class=" td1 urduText mcqstable brdrnone" style="width:90% ;text-align:right;font-size:16px !important;
                                font-weight:bold !imprtanr;font-family:Jameel Noori Nastaleeq" contenteditable="true">
         ...
         <tbody>
             <tr class="tr1 mcqstable">
                 <td style="font-size:12px !important" class="td1 mcqstable urduText">
                     ...
                     <span><span style="font-family:Jameel Noori Nastaleeq" contenteditable="true">{!! $mcq->option_d !!}</span></span>
                     @endif
                 </td>
                 <td style="font-size:12px !important" class="td1 mcqstable urduText">
                     ...
                     <span><span style="font-family:Jameel Noori Nastaleeq" contenteditable="true">{!! $mcq->option_c !!}</span></span>
                     @endif
                 </td>
                 <td style="font-size:12px !important" class="td1 mcqstable urduText">

                     <span class="numberCircle"><span>ب۔</span></span>
                     <span><span style="font-family:Jameel Noori Nastaleeq" contenteditable="true">{!! $mcq->option_b !!}</span></span>
                 </td>
                 <td style="font-size:12px !important" class="td1 mcqstable urduText">

                     <span class="numberCircle"><span>ا۔</span></span>
                     <span><span style="font-family:Jameel Noori Nastaleeq" contenteditable="true">{!! $mcq->option_a !!}</span></span>
                 </td>
