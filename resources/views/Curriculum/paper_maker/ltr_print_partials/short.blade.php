                ...
                <tbody>
                    <tr class="tr1">
                        <td class="textleft td1 QuestHead" style="width:5%;font-weight:bold !important;">
                            ({{ $input['total_short_marks'] }})
                        </td>
                        <td colspan="4" class=" td1 QuestHead" style="text-align:right;font-weight:bold !important;font-family:Jameel Noori Nastaleeq;" contenteditable="true">
                            سوال {{ $question_count }} : &nbsp; {{ $input['short_question_top_text'] }}
                            @php
                            $question_count++;
                            $page_break_count = $page_break_count+ $short_questions->count();
            ...
            <table style="border:none;margin-right:10px">
                <tbody>
                    <tr class="tr1">
                        ...
                        <td class=" td1 urduText" style="width:85%;text-align:right;font-size:14px !important;font-family: Noori Nastaleeq" contenteditable="true">
                            {!! $short->question !!}
                        </td>
