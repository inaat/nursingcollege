                  ...
                  <div class="row">
                      <div class="col-md-12">
                         ...
                         <div class="col-md-6 p-2 ">
                             ...
                             {!! Form::textarea('short_question_top_text', ($class_subject->subject_input=='ur') ? 'مختصر سوالات کے جواب دیں۔':'Attempt any SIX Parts out of the following. Each Part carries equal marks.', [
                                 'class' => 'form-control'. ' '. $urdu_input ,
                                 'style' => 'width:100%',
                                 'required',
                                 'rows'=>2
