                ...
                <table style="border:none; margin-left:15px; " class="mcqstable">
                    <tbody>
                        <tr class="tr1 mcqstable">
                            <td colspan="8" class=" halfdevider td1 mcqstable" style="text-align:left !important;font-size:14px !important" contenteditable="true">

                                <span style="font-weight:bold !important font-size:14px " contenteditable="true">
                    ...
                    <tbody>
                        <tr class="tr1 mcqstable">
                            ...
                            <td style="" class="td1 mcqstable">
                                ...
                                <span style="text-align:center;font-size:14px !important" contenteditable="true">{!! $mcq->option_a !!}</span>

                            </td>
                            <td style="" class="td1 mcqstable">
                                <span class="circle">b</span>

                                <span style="text-align:center;font-size:14px !important" contenteditable="true">{!! $mcq->option_b !!}</span>
                            ...
                            <td style="" class="td1 mcqstable">
                                ...
                                <span style="text-align:center;font-size:14px !important" contenteditable="true">{!! $mcq->option_c !!}</span>
                                @endif
                            ...
                            <td style="" class="td1 mcqstable">
                                ...
                                <span style="text-align:center;font-size:14px !important" contenteditable="true">{!! $mcq->option_d !!}</span>
                                @endif
                            </td>
