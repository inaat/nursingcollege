 ...
 <div class="row">
     @if (!empty($input['masculine_and_feminine_question_header']))
     <div class="head">
         <h6>{{ $input['masculine_and_feminine_question_header'] }}
         </h6>
     </div>
     @endif
         ...
         <tbody>
             <tr class="tr1">
                 <td colspan="4" class="td1 QuestHeadLeft" style="text-align:left;font-size:12px ">
                     Q.{{ $question_count }}:{{ $input['masculine_and_feminine_question_top_text'] }}
                     @php
                     $question_count++;
                     @endphp
                 </td>
                 ...
                 <td colspan="4" class="QuestHeadLeft textright  td1" style="">
                     ...
                     <span style="float:right;font-size:16px" id="qmrks"><strong>({{ $input['total_masculine_and_feminine_marks'] }})</strong></span>
             ...
             <tr class="tr1 shortstable">
                 ...
                 <td colspan="10" class=" halfdevider td1 shortstable" style="text-align:left!important;font-size:14px !important">
                     ...
                     <span style="margin-left:15px;">
                         {!! $masculine_and_feminine->question !!}</span>
                 </td>
