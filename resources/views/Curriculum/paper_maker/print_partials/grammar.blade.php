 ...
 <div class="row">
     @if (!empty($input['grammar_question_header']))
     <div class="head">
         <h6>{{ $input['grammar_question_header'] }}
         </h6>
     </div>
     @endif
         ...
         <tbody>
             <tr class="tr1">
                 <td colspan="4" class="td1 QuestHeadLeft" style="text-align:left;font-size:12px ">
                     Q.{{ $question_count }}:{{ $input['grammar_question_top_text'] }}
                     @php
                     $question_count++;
                     @endphp
                 </td>
                 ...
                 <td colspan="4" class="QuestHeadLeft textright  td1" style="">
                     ...
                     <span style="float:right;font-size:16px" id="qmrks"><strong>({{ $input['total_grammar_marks'] }})</strong></span>
