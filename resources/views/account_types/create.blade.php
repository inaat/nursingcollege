<div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <div class="form-group">
                {!! Form::label('debit_increases', __( 'english.debit_increases_balance' ) . ':') !!}
                {!! Form::checkbox('debit_increases', 1, true, ['class' => 'form-check-input']) !!}
                {!! Form::label('debit_increases', __( 'english.yes' ), ['class' => 'form-check-label']) !!}
            </div>

            <div class="form-group">
                {!! Form::label('credit_increases', __( 'english.credit_increases_balance' ) . ':') !!}
                {!! Form::checkbox('credit_increases', 1, false, ['class' => 'form-check-input']) !!}
                {!! Form::label('credit_increases', __( 'english.yes' ), ['class' => 'form-check-label']) !!}
            </div>
