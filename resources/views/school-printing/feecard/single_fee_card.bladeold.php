...
<body style="color:#000">
    @foreach ($student as $std)
        {{-- <div style=" border:1px solid black; margin:5px; page-break-after: always;"> --}}
            ...
            <div class="flex_container">
                <div class="flex_item_left ">
                    <div id="head">
                        <h6>Fee Upto @lang('lang.months.' . $std['current_transaction']->month ) Session ({{ $std['current_transaction']->session->title }})
                        </h6>
                    </div>
                    <div class="info" style="border: 1px solid #000; padding:1px; zoom:95%">
                        <div class="info_left">
                             <strong>@lang('lang.challan_no'):</strong>
                                <strong>{{ ucwords($std['current_transaction']->voucher_no) }}</strong>
                                <span style="margin-left:4px"><strong>@lang('lang.date'):</strong>
                                    <strong>{{ @format_datetime($std['current_transaction']->transaction_date) }}</strong></span><br>
                                <strong>@lang('lang.roll_no'):</strong>
                                <strong>{{ ucwords($std['current_transaction']->student->roll_no) }}</strong>
                                <span style="margin-left:4px"><strong>@lang('lang.class'):{{ $std['current_transaction']->student_class->title .'  ' .$std['current_transaction']->student_class_section->section_name }}
                                    </strong></span><br>
                                <span style="margin-left:4px"><strong>@lang('lang.student_name'):
                                        <strong>{{ ucwords($std['current_transaction']->student->first_name . ' ' . $std['current_transaction']->student->last_name) }}</strong>
                                    </strong></span><br>

                                <span><strong>@lang('lang.father_name'):{{ ucwords($std['current_transaction']->student->father_name) }}
                                    </strong></span>
                                <span style="margin-left:4px"><strong>@lang('lang.cell'):{{ ucwords($std['current_transaction']->student->mobile_no) }}
                                    </strong></span>
                                <br>
                                <span><strong>@lang('lang.address'):{{ ucwords($std['current_transaction']->student->std_permanent_address) }}
                                    </strong></span>
    ...
    @endif
                    ...
                    <table style="zoom:70%; line-height:1.5">
                        ...
                        <tr>
                            ...
                            @foreach ($std['balance']['bf'] as $b)
                                @if ($loop->iteration == $std['fee_month'] + 2)
                ...
                <tr>
                    ...
                    <td><strong>@lang('lang.discount')</strong></td>
        ...
        <h6 style="text-align:center;color:#000;display:inline">@lang('lang.current_fee')</h6>
        <table style="zoom:70%; line-height:1.5">
        ...
        <table style="width:50% ; float:right;margin-top:1px; ">
            <thead class="table-light">
                <tr>
                    <th><strong>@lang('lang.net_total')</strong></th>
                    <td>{{ number_format($std['total_due'], 0) }}</td>
                </tr>
                <tr>
                    <th><strong>@lang('lang.paid')</strong></th>
                ...
                <tr>
                    <th><strong>@lang('lang.balance')</strong></th>
                    <td></td>
                </tr>
        ...
        <p> <br><strong>@lang('lang.adjustment')</strong>
            <strong>____________________</strong>
        </p>
        <p>
            <strong>@lang('lang.account_officer')</strong>
    ...
    <div class="flex_item_right">
        ...
        <p style="zoom: 80%"> <strong>@lang('lang.roll_no'):</strong>
            <span
                class=""><strong>{{ ucwords($std['current_transaction']->student->roll_no) }}</strong></span>
            <br>
            <br>
            <strong>@lang('lang.old_roll_no'):</strong>
            <span
        ...
        <p> <strong>@lang('lang.adjustment')</strong>
        ...
        <table style="width:50% ; float:right;margin-top:1px; ">
            <thead class="table-light">
                <tr>
                    ...
                    @else 
                    <td  ><strong>{{ number_format($std['total_due'], 0) }}</strong></td>
                    @endif 
                </tr>
                <tr>
