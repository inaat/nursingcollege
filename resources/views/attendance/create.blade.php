...
@section('title', __('english.student_attendance'))
 ...
 <div class="page-wrapper">
     <div class="page-content">
         ...
         <!--end breadcrumb-->
         {!! Form::open(['url' => action('AttendanceController@attendanceAssignSearch'), 'method' => 'post', 'class'=>'needs-validation was-validated','novalidate'.'id' =>'search_student_fee' ,'files' => true]) !!}
