...
@section('title', __('english.student_attendance'))
 ...
 <div class="page-wrapper">
     <div class="page-content">
         ...
         <!--end breadcrumb-->
         {!! Form::open(['url' => action('Hrm\HrmAttendanceController@attendanceAssignSearch'), 'method' => 'post', 'class'=>'needs-validation was-validated','novalidate'.'id' =>'search_student_fee' ,'files' => true]) !!}
                 ...
                 <div class="row m-0">
                     ...
                     <div class="col-md-3 p-2">
                         ...
                         <div class="input-group flex-nowrap"> <span class="input-group-text" id="addon-wrapping"><i class="fa fa-calendar"></i></span>
                             ...
                             {!! Form::text('date', @format_date('now'), ['class' => 'form-control date-picker', 'placeholder' => __('settings.start_date'), 'readonly']) !!}
