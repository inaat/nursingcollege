<div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
        ...
        <div class="modal-header bg-primary">
            <h5 class="modal-title" id="exampleModalLabel">@lang('english.register_new_designation')</h5>
        ...
        <p class="text-muted">Register as many designations as you need. Please provide required information to proceed next...</p>
            <div class="form-group">
                ...
                {!! Form::text('designation', null, ['class' => 'form-control', 'required', 'placeholder' => __( 'english.designation_title' ) ]) !!}
            </div>
