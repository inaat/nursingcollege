<div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
        ...
        {!! Form::open(['url' => action('Hrm\HrmTransactionPaymentController@store'), 'method' => 'post', 'id' => 'transaction_payment_add_form', 'files' => true]) !!}
                ...
                <div class="row payment_row">
                    ...
                    @if (!empty($accounts))
                        <div class="col-md-6 p-1">
                            ...
                            <div class="input-group flex-nowrap"> <span class="input-group-text" id="addon-wrapping"><i
                                        class="fas fa-money-bill-alt"></i></span>
                                {!! Form::select('account_id', $accounts, !empty($payment_line->account_id) ? $payment_line->account_id : 8, ['class' => 'form-select select2 ', 'id' => 'account_id', 'required', 'style' => 'width:100%;']) !!}
