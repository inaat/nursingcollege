...
<div class="page-wrapper">
    ...
    <div class="modal fade document_modal contains_select2" tabindex="-1" role="dialog" aria-labelledby="gridSystemModalLabel">
     ...
     @include('hrm.employee.attendance_modal')
    @endsection
        ...
        $.ajax({
            ...
            success: function (result) {
                if (result.success == true) {
                    ...
                    $('#calendar').html('<div id="my-calendar"></div>');
                     calendar();
                    $("#attendance_form")
            ...
            .val(0);
                                   $("#attendance_form")
            .find("#check_single").attr('checked', false);
                                   $("#attendance_form")
            .find("#check_all").attr('checked', false);
                } else {
   ...
   function calendar(){
        $("#my-calendar").zabuto_calendar({
                ...
                //alert the date
                      ...
                      $("#attendance_form")
            .find("#attendance_employee_id")
            .val($('#employee_id').val());
                      $("#attendance_form")
            .find("#attendance_date")
            .val(date);
