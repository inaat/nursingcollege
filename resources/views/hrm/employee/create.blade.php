...
@section('title', __('english.add_new_employee'))
@section('wrapper')
                ...
                <div class="ps-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">@lang('english.employee')</li>
                        </ol>
                    </nav>
                </div>
            </div>
                        ...
                        <div class="col-md-10">
                            <div class="row">
                                ...
                                <div class="col-md-4 p-1">
                                    ...
                                    {!! Form::text('employeeID', $admission_no, ['class' => 'form-control', 'required', 'readonly', 'placeholder' => __('english.employee_id')]) !!}
                                ...
                                <div class="col-md-4 p-1">
                                    ...
                                    <div class="input-group flex-nowrap"> <span class="input-group-text"
                                        ...
                                        {!! Form::text('joining_date', @format_date('now'), ['class' => 'form-control date-picker', 'readonly', 'placeholder' => __('english.joining_date')]) !!}
                                ...
                                <div class="card border-top border-0 border-4 border-info">
                                    <div class="card-body">
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-8">
                                                {!! Form::textarea('current_address', null, ['class' => 'form-control ', 'rows' => 1, 'placeholder' => __('english.current_address')]) !!}
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-8">
                                                {!! Form::textarea('permanent_address', null, ['class' => 'form-control ', 'rows' => 1, 'placeholder' => __('english.permanent_address')]) !!}
                                ...
                                <div class="card border-top border-0 border-4 border-info">
                                    <div class="card-body">
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-8">
                                                {!! Form::text('bank_details[account_name]', null, ['class' => 'form-control', 'placeholder' => __('english.account_holder')]) !!}
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-8">
                                                {!! Form::text('bank_details[account_number]', null, ['class' => 'form-control', 'placeholder' => __('english.account_number')]) !!}
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-8">
                                                {!! Form::text('bank_details[bank]', null, ['class' => 'form-control', 'placeholder' => __('english.bank')]) !!}
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-8">
                                                {!! Form::text('bank_details[bin]', null, ['class' => 'form-control', 'placeholder' => __('english.bin')]) !!}
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-8">
                                                {!! Form::text('bank_details[branch]', null, ['class' => 'form-control', 'placeholder' => __('english.branch')]) !!}
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-8">
                                                {!! Form::text('bank_details[tax_payer_id]', null, ['class' => 'form-control', 'placeholder' => __('english.tax_payer_id')]) !!}
                  ...
                  {!! Form::label('role', __( 'english.role' ) . ':*') !!} @show_tooltip(__('english.admin_role_location_permission_help'))
                    ...
                    <div class="row pt-4">
                        ...
                        <div class="col-md-4 p-1">
                            ...
                            {!! Form::email('email', $admission_no.'@gmail.com', ['class' => 'form-control', 'placeholder' => __('english.email'), 'id' => 'email']) !!}
                        </div>
                        <div class="col-md-4  p-1">
