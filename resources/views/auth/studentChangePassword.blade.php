<div class="modal-dialog" role="document">
    <div class="modal-content">
        ...
        {!! Form::open(['url' => action([App\Http\Controllers\SessionController::class, 'postStudentChangePassword']), 'method' => 'post', 'id' => 'change_password_form' ]) !!}
...
{!! Form::hidden('id', $id, ['id' => 'hidden_input_id']) !!}
