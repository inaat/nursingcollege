<div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
        <div class="modal-header bg-primary">
            <h5 class="modal-title text-white" id="exampleModalLabel">@lang('english.today_paid_fee_details')</h5>
        ...
        <div class="modal-body">
            <div class="row">
                <div class="table-responsive" >
                    ...
                    @endphp
                    <table class="table mb-0" id="table_id_table" width="100%">
                        ...
                        <tbody>
                            ...
                            @if( $pay->fee_transaction->type=='fee'|| $pay->fee_transaction->type=='admission_fee'|| $pay->fee_transaction->type=='other_fee'|| $pay->fee_transaction->type=='opening_balance')
                            <tr>
                                ...
                                <td>{{ $pay->student ? $pay->student->current_class->title : ' '}}</td>
