...
<body>  
    <div class="card">
               <div class='date '><b>@lang('english.from') {{ @format_date($start_date) }} @lang('english.to') {{ @format_date($end_date) }} <b></div>
                 ...
                 <h5 class="head text-primary">@lang('english.attendance_list')@lang('english.of') @lang('english.class') :<span class="mg-left">{{ $student[0]->current_class->title }}</span><span class="mg-left">{{ $student[0]->current_class_section->section_name}}</span></h5>
