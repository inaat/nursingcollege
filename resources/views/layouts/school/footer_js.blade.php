...
<script>
console.log($.fn.niceSelect ? "Nice Select loaded" : "Nice Select not loaded");
...
<script>
    // Logo
    var nav_logo = "{{ url('uploads/front_image/' . session()->get('front_details.logo_image')) ?? '' }}";
    if (nav_logo == null || nav_logo == '') {
        nav_logo = "{{ url('uploads/front_image/' . session()->get('front_details.logo_image'))?? asset('assets/landing_page_images/Logo1.svg') }}";
    }

    var footer_logo = "{{ url('uploads/front_image/' . session()->get('front_details.logo_image')) ?? '' }}";
