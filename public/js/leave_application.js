$(document).ready(function () {
        ...
        $.ajax({
            ...
            success: function(result) {
                if (result.success == true) {
                    ...
                    leave_applications_for_employee_table.ajax.reload();
    ...
    //leave_applications_for_employee_table
    var leave_applications_for_employee_table = $(
        "#leave_applications_for_employee_table"
    ).DataTable({
        processing: true,
        serverSide: true,
