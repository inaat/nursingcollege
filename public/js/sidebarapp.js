$(function () {
	...
	$("#headercolor1").on("click", function () {
		...
		localStorage.setItem('headercolor', 'color-header headercolor1');
	...
	$("#headercolor2").on("click", function () {
		...
		localStorage.setItem('headercolor', 'color-header headercolor2');
	...
	$("#headercolor3").on("click", function () {
		...
		localStorage.setItem('headercolor', 'color-header headercolor3');
	...
	$("#headercolor4").on("click", function () {
		...
		localStorage.setItem('headercolor', 'color-header headercolor4');
	...
	$("#headercolor6").on("click", function () {
		...
		localStorage.setItem('headercolor', 'color-header headercolor6');
	...
	$("#headercolor7").on("click", function () {
		...
		localStorage.setItem('headercolor', 'color-header headercolor7');
	...
	$("#headercolor8").on("click", function () {
		...
		localStorage.setItem('headercolor', 'color-header headercolor8');
